...
import org.dominokit.rest.shared.request.ServicePath;

public class ServicePathGwtTest extends GWTTestCase {
  ...
  public void testConstructor_nullToken_throws() {
    try {
  ...
  public void testConstructor_emptyToken_ok_andEmpty() {
    ServicePath s = sp("");
  ...
  public void testBasic_paths_query_fragment() {
  ...
  public void testMatrix_singleSegment_singleParam() {
  ...
  public void testMatrix_multipleSegments_multipleParams() {
  ...
  public void testMatrix_emptyValueIsPreserved() {
  ...
  public void testMatrix_firstSegmentWithoutName_allowed() {
  ...
  public void testMatrix_orderOfValuesIsPreserved() {
  ...
  public void testEndsWithPath_ignoresMatrix() {
  ...
  public void testQuery_set_append_remove_behaviour() {
  ...
  public void testQuery_missingEquals_throws() {
    try {
      sp("/a?bad#frag");
      fail("Expected IllegalArgumentException for missing '=' in query");
    } catch (IllegalArgumentException e) {
      // expected
    }
  }

  public void testQuery_emptyValue_isKept() {
    ServicePath s = sp("/a?e=&k=v");
    assertEquals("e=&k=v", s.query());
  }

  public void testMatrix_set_append_remove_behaviour() {
  ...
  public void testMatrix_invalidSegment_throws() {
    ServicePath s = sp("/a");
    try {
      s.setMatrixParameter(5, "k", "v");
      fail("Expected IndexOutOfBoundsException for invalid matrix segment index");
    } catch (IndexOutOfBoundsException e) {
      // expected
    }
  }

  public void testValue_withRoot_noExtraSlashWhenAppropriate() {
  ...
  public void testEndsWithPath_various() {
  ...
  public void testFragments_parsingAndRendering() {
  ...
  public void testFragments_emptyOrMissing() {
    ServicePath s1 = sp("/a#");
  ...
  public void testEquals_ignores_order_of_query_and_matrix_values_but_considers_multiplicity() {
  ...
  public void testReplacePath_updatesSegmentName_andRendering_nowCorrect() {
  ...
  public void testPathWithoutMatrix_returns_names_only() {
    ServicePath s = sp("/x;a=1;b=2/y;c=3");
    assertEquals("x/y", s.pathWithoutMatrix());
    assertEquals("x;a=1;b=2/y;c=3", s.path());
  }

  public void testNoRootValue_and_value_composition_cases() {
  ...
  public void testIsEmpty_onlyWhen_allPartsEmpty() {
  ...
  public void testMatrixValues_invalidIndex_throws() {
    try {
      sp("/a").matrixParameterValues(1, "k");
      fail("Expected IndexOutOfBoundsException for invalid matrix index");
    } catch (IndexOutOfBoundsException e) {
      // expected
    }
  }

  public void testComplex_combined_roundTrip_and_mutations() {
  ...
  public void testFragments_preserve_internal_hash_characters() {
    ...
    assertEquals(Arrays.asList("alpha#beta"), s.fragments());
  ...
  public void testFragments_double_hash_after_delimiter_strips_extra_leading_hashes() {
