 ...
 *
 * <p>The type of the annotated parameter, field or property must either:
 *
 * <ul>
 *   <li>Be {@link javax.ws.rs.core.PathSegment}, the value will be the final segment of the
 *       matching part of the path. See {@link javax.ws.rs.core.UriInfo} for a means of retrieving
 *       all request path segments.
 *   <li>Be {@code List<javax.ws.rs.core.PathSegment>}, the value will be a list of {@code
 ...
 * </ul>
 *
 * <p>The injected value corresponds to the latest use (in terms of scope) of the path parameter.
...
public @interface PathParam {
   ...
   *
   * <p>E.g. a class annotated with: {@code @Path("widgets/{id}")} can have methods annotated whose
