...
public class MediaType {
   ...
   * semantics of the parameter name, see {@link <a
   * href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec3.html#sec3.7">HTTP/1.1</a>}. This method
   * assumes that values are case-sensitive.
   *
   * <p>Note that the {@code equals(...)} implementation does not perform a class equality check
   ...
   *
   * <p>Note that the {@link #equals(Object)} implementation does not perform a class equality check
   * ({@code this.getClass() == obj.getClass()}). Therefore any class that extends from {@code
