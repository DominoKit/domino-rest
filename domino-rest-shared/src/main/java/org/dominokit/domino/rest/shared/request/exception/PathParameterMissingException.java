...
import org.dominokit.domino.rest.shared.request.UrlFormatter;

/**
 * An exception is thrown when trying to replace path parameters when there is no expressions to
 * replace
 *
 * @see UrlFormatter
 */
